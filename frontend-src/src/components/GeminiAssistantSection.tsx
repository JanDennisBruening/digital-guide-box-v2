        ...
        >
          <div className="relative flex-1 flex items-stretch">
            <textarea
              ...
              rows={2}
              disabled={isLoading}
              className="w-full resize-none px-4 py-3 text-sm font-body rounded-xl border border-slate-300 focus:border-[#235cbb] focus:ring-2 focus:ring-blue-100 outline-none transition-all disabled:bg-slate-50 disabled:text-slate-400 placeholder:text-slate-400 leading-snug min-h-[3.5rem] h-[3.5rem] sm:h-full box-border"
            />
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-6 rounded-xl font-semibold font-body text-sm text-white bg-[#235cbb] hover:bg-[#1b4a99] active:bg-[#153b7b] disabled:opacity-40 disabled:pointer-events-none transition-all shadow-xs whitespace-nowrap self-stretch min-h-[3.5rem] h-[3.5rem] sm:h-auto cursor-pointer box-border"
          >
