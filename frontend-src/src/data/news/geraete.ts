...
export const GERAETE_NEWS: NewsItem[] = [
  {
    ...
    "sources": [
      {
        "title": "Digital Guide Box – Jan Dennis Brüning",
        "url": "https://www.janbruening.de"
      }
    ]
  },
  {
    ...
    "sources": [
      {
        "title": "BSI – Schutz vor digitalem Stress und Benachrichtigungsflut",
  ...
  },
  {
    ...
    "sources": [
      {
        "title": "Verbraucherzentrale: Smartphone-Akku richtig laden und schonen",
  ...
  },
  {
    ...
    "sources": [
      {
        "title": "Google Support: Speicherplatz auf Android-Geräten freigeben",
  ...
  },
  {
    ...
    "sources": [
      {
        "title": "BSI – Barrierefreiheit und Bedienungshilfen am Smartphone",
        "url": "https://www.bsi.bund.de"
      }
    ]
  }
